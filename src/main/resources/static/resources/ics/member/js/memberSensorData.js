window.onload = function() {
	...
	var api = {
		//"sensorSelect" : "/member/sensor/select",
		"sensorLogList" : "/member/sensor/logList",
		"sensorLogChart" : "/member/sensor/searchChartLog"		
	}
	...
	function select(index) {
		...
		options.forEach((item) => {
			item.addEventListener('click', function(e) {
				...
				if(selectInput.getAttribute("id")=="sensorInput"){
